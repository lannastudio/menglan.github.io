---
layout: post
title: "Objective-C __weak 弱引用实现原理深度解析"
date: 2025-07-30 09:00:00 +0800
categories: iOS 底层
tags: [Objective-C, Runtime, weak, 内存管理]
---

# Objective-C `__weak` 弱引用实现原理深度解析
...
> 如果你需要更精细的代码高亮、目录折叠、或者想要进一步拆解成多级小节，也可以继续提需求！
> 也可以直接贴到 `_posts/2025-07-30-objc-weak.md` 作为一篇高质量底层源码博客。
